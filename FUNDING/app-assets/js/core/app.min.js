  ...
  o(n).on("load", function () {
    ...
    !1 === o.app.nav.initialized && o.app.nav.init({ speed: 300 }),
      ...
      0 < o(".navbar-hide-on-scroll").length &&
        (o(".navbar-hide-on-scroll.fixed-top").headroom({
          offset: 205,
          tolerance: 5,
          classes: {
            initial: "headroom",
      ...
      setTimeout(function () {
        var e;
        o("body").hasClass("vertical-content-menu") &&
          ((e = o(".main-menu").height()),
          o(".content-body").height() < e &&
            o(".content-body").css("height", e));
      }, 500),
      o('a[data-action="collapse"]').on("click", function (e) {
        e.preventDefault(),
          o(this).closest(".card").children(".card-content").collapse("toggle"),
          o(this)
            .closest(".card")
      ...
      o('a[data-action="expand"]').on("click", function (e) {
        e.preventDefault(),
          ...
          o(this).closest(".card").toggleClass("card-fullscreen");
      }),
      0 < o(".scrollable-container").length &&
        o(".scrollable-container").perfectScrollbar({ theme: "dark" }),
      ...
      o('.card .heading-elements a[data-action="collapse"]').on(
        "click",
        function () {
          var e,
    ...
    "vertical-compact-menu" != e &&
      ...
      ("vertical-menu-modern" == l.data("menu")
        ? "true" === localStorage.getItem("menuLocked") &&
          o(".main-menu-content")
            .find("li.active")
            .parents("li")
            .addClass("open")
    ...
    if (
      (n.css("height", a),
      l.hasClass("boxed-layout") &&
        (l.hasClass("vertical-overlay-menu") ||
          l.hasClass("vertical-compact-menu")))
    ) {
      var t = o(".main-menu").width(),
        i = o(".app-content").position().left - t;
      l.hasClass("menu-flipped")
        ? o(".main-menu").css("right", i + "px")
        : o(".main-menu").css("left", i + "px");
    }
    ...
    o(e).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
      return (
        ...
        0 < o("#collapsed-sidebar").length &&
          setTimeout(function () {
            l.hasClass("menu-expanded") || l.hasClass("menu-open")
              ? o("#collapsed-sidebar").prop("checked", !1)
    ...
    o(e).on("click", ".main-menu-footer .footer-toggle", function (e) {
      return (
        e.preventDefault(),
        o(this).find("i").toggleClass("pe-is-i-angle-down pe-is-i-angle-up"),
        o(".main-menu-footer").toggleClass("footer-close footer-open"),
        !1
      );
    }),
    ...
    o(e).ready(function () {
      o(".step-icon").each(function () {
        ...
        0 < e.siblings("span.step").length &&
          ...
          o(this).appendTo(o(this).siblings("span.step")));
      });
    }),
    o(n).resize(function () {
