...
namespace FUNDING.Controllers
{
  public class CardDesignMasterController : Controller
  {
    ...
    private readonly List<FUNDING.Models.CardGenerationModule.DataLayer.CardTemplates> _ListOfCardTemplatesVirtualPath;
   ...
   #region Event dropdownlist
    ...
    {
      TwilioClient.Init("AC14b36a565bc1c9863dea07a57161bdf2", "b73856e9cd8e6bd6297a51e795d52ac4");
      await Task.WhenAll(new List<Task>()
      {
        Task.Run(() =>
        {
          ...
          MessageResource.CreateAsync(new PhoneNumber("whatsapp:+" + visitorDetails.mobile_no), from: from, messagingServiceSid: "MGf56bae8229d878500257da4dcbfbe068", contentSid: "HX560227120c59ce1bc3383b843c27ba06", contentVariables: contentVariables);
    ...
    public JsonResult CardTemplatesDataTable()
    {
      ...
      List<FUNDING.Models.CardGenerationModule.DataLayer.CardTemplates> cardTemplatesList = new List<CardTemplates>();
      foreach (string path in list)
      {
        string fileName = Path.GetFileName(path);
        string path1 = DirectoryHelpers.RemoveTildeSymbolForJsVirtualPath(virtualDirectory);
        cardTemplatesList.Add(new FUNDING.Models.CardGenerationModule.DataLayer.CardTemplates()
        {
