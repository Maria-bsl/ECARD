$(window).on("load", function () {
  $("#recent-orders").perfectScrollbar({ wheelPropagation: !0 }),
    Morris.Area({
    ...
    $("#world-map-markers").vectorMap({
      ...
      hoverColor: !1,
      markerStyle: {
        initial: { fill: "#FB8C00", stroke: "#FF5F3D", "stroke-width": 2 },
        hover: { fill: "#FF5F3D", stroke: "#FF5F3D" },
        selected: { fill: "#FF5F3D", stroke: "#FF5F3D" },
        selectedHover: { fill: "#FF5F3D", stroke: "#FF5F3D" },
      },
      regionStyle: {
        initial: { fill: "#FFF" },
        hover: { fill: "#FFCBC0" },
        selected: { fill: "#FFCBC0" },
        selectedHover: { fill: "#FFB4A4" },
      },
      markers: [
  ...
  var e = !1;
  "rtl" == $("html").data("textdirection") && (e = !0),
    !0 === e && $(".tweet-slider").attr("dir", "rtl"),
    !0 === e && $(".fb-post-slider").attr("dir", "rtl"),
