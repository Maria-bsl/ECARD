...
function mobileNumSponserValidate(e) {
...
function showSMTPModalsponse(e) {
    sponser = "";
    var txtname = document.getElementById("txtname");
    var txtpobox = document.getElementById("txtpobox");
    var txtadd = document.getElementById("txtadd");
    ...
    if (e.value.indexOf('Edit') > -1) {
        ...
        for (var i = 0, row = null; i < rows.length; i++) {
            ...
            if (row.cells[14].innerHTML.indexOf(e.id) > -1) {
                var st = row.cells[13].innerHTML;
                if (st == "Pending" || st == "Return" || st == "Approved") {
                    jQuery("#txtname").prop('disabled', true);
                    jQuery("#txtpobox").prop("disabled", true);
                    jQuery('#txtadd').prop("disabled", true);
                    jQuery('#ddlreg').prop("disabled", true);
                    jQuery('#ddldist').prop("disabled", true);
                    jQuery('#ddlward').prop("disabled", true);
                    jQuery('#txtper').prop("disabled", true);
                    jQuery('#txtmob').prop("disabled", true);
...
function validateEmployeeSponser() {
    var txtname = document.getElementById("txtname");
    var txtpobox = document.getElementById("txtpobox");
    var txtadd = document.getElementById("txtadd");
    var ddlreg = document.getElementById("ddlreg");
...
function getSMTPValues_Spn_Ret() {
    if (doublemobs == false) {
        jQuery("#loader").css("display", "none");
        message = error;
        type = 'danger';
