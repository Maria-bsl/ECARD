HiQPdf Free HTML to PDF Converter for .NET
==========================================
...
The NuGet package for .NET Core and .NET Standard is HiQPdf.Free.NetCore .
...
You can download free trial packages for the full version of HiQPdf Library for .NET from http://www.hiqpdf.com/downloads.aspx web page.
